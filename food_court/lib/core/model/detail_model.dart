...
CQDetailModel cqDetailModelFromJson(String str) => CQDetailModel.fromJson(json.decode(str));

String hyDetailModelToJson(CQDetailModel data) => json.encode(data.toJson());
...
class CQDetailModel {
  ...
  factory CQDetailModel.fromJson(Map<String, dynamic> json) => CQDetailModel(
    iid: json["iid"],
